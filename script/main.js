...
const messages = [
    "Tap dimana aja yaaa",
    "hey keysha ❤️",
    "aku mau ngomong sesuatu hehee",
    "coba tap",
    "tap lagi dong",
    "ayo semangat tap layarnya",
    "ciee tap tap layar",
    "hehee ini terakhir",
    "serius",
    "ini",
    "yang",
    "terakhir",
    "tapi becandaa sayangg hehee",
    "jangan marah yaa cantikk",
    "aku tau pasti kamu kesal",
    ":)",
    "yaudah",
    "jadi...",
    "aku cuma mau bilang",
    "pergi ke pasar beli ikan lele",
    "i love you keysha ❤️",
    "heheee apasi aku",
    "maaf yaa gajelas pacar kamu",
    "tapi aku serius", 
    "aku beneran sayang banget banget sama kamu",
    "coba tap tombol dibawah ini sayangg"
];
